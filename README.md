...
- product-boundary workflow that reviews, safely routes, or blocks asks that would turn Gigi into recruiting, background-check, data-brokerage, scoring-authority, or autonomous-agent behavior
